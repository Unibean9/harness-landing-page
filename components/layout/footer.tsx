...
export function Footer() {
  return (
    <footer className="px-4 pb-8 mt-auto pt-20">
      <div className="mx-auto flex max-w-7xl flex-col gap-4 rounded-[20px] bg-brand-surface p-5 text-sm text-body md:flex-row md:items-center md:justify-between border border-border">

...
```bash
curl -fsSL "https://raw.githubusercontent.com/ThinhTP204/harness-engineering/main/scripts/install-harness.sh?$(date +%s)" | bash -s -- --yes
```

```powershell
& ([scriptblock]::Create((irm "https://raw.githubusercontent.com/ThinhTP204/harness-engineering/main/scripts/install-harness.ps1"))) -Yes
```

```bash
curl -fsSL "https://raw.githubusercontent.com/ThinhTP204/harness-engineering/main/scripts/install-harness.sh?$(date +%s)" | bash -s -- --merge --yes
```

```powershell
& ([scriptblock]::Create((irm "https://raw.githubusercontent.com/ThinhTP204/harness-engineering/main/scripts/install-harness.ps1"))) -Merge -Yes
```

```bash
curl -fsSL "https://raw.githubusercontent.com/ThinhTP204/harness-engineering/main/scripts/install-harness.sh?$(date +%s)" | bash -s -- --merge --refresh-agent-shim --yes
```

```powershell
& ([scriptblock]::Create((irm "https://raw.githubusercontent.com/ThinhTP204/harness-engineering/main/scripts/install-harness.ps1"))) -Merge -RefreshAgentShim -Yes
```

...
import { usePrinciplesChrome } from "@/app/nguyen-ly/components/principles-chrome-root";
...
interface SddMobileBarProps {
  activeSlug: string;
  tocItems?: PrinciplesTocItem[];
}

export function SddMobileBar({ activeSlug, tocItems }: SddMobileBarProps) {
    ...
    >
      <div className="principles-mobile-bar-inner">
        <button
          ...
          aria-controls="sdd-mobile-menu-panel"
        ...
        {hasToc ? (
          <button
            ...
            aria-controls="sdd-mobile-toc-panel"
    ...
    <AnimatePresence>
      {openPanel ? (
        <>
          ...
          <motion.div
            key={`sdd-mobile-panel-${openPanel}`}
            id={openPanel === "menu" ? "sdd-mobile-menu-panel" : "sdd-mobile-toc-panel"}
            className={cn(
          ...
          >
            {openPanel === "menu" ? (
              <SddNav activeSlug={activeSlug} variant="panel" onNavigate={closePanel} />
            ) : (
              <PrinciplesToc
                items={tocItems!}
                variant="panel"
